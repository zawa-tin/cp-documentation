...
data:
  ...
  bundledCode: "#line 1 \"Test/CF/EC150-F.test.cpp\"\n// #define PROBLEM \"https://codeforces.com/contest/1841/problem/F\"\
    ...
    \        res.popBack();\n    return res;\n}\n\n} // namespace geometryZ2\n\n}\
    \ // namespace zawa\n#line 10 \"Test/CF/EC150-F.test.cpp\"\n\n#line 13 \"Test/CF/EC150-F.test.cpp\"\
    ...
    \ i = 0 ; i < ssize(prod) ; i++) {\n        Point p = prod[i];\n        ans =\
    \ max(ans,__int128_t(p.x())*p.x()+__int128_t(p.y())*p.y());\n    }\n    string\
    \ out;\n    while (ans) {\n        out += ans%10 + '0';\n        ans /= 10;\n\
    \    }\n    if (out.empty())\n        out += '0';\n    ranges::reverse(out);\n\
    \    cout << out << '\\n';\n#else\n    cout << \"Hello World\\n\";\n#endif\n}\n"
  code: "// #define PROBLEM \"https://codeforces.com/contest/1841/problem/F\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/lesson/2/ITP1/1/ITP1_1_A\"\
    \n\n/*\n * Educational Codeforces Round 150 F. Monocarp and a Strategic Game\n\
    \ * https://codeforces.com/contest/1841/submission/367948884\n */\n\n#include\
    \ \"../../Src/GeometryZ2/MinkowskiSum.hpp\"\n\n#include <iostream>\n#include <algorithm>\n\
  ...
  verifiedWith: []
documentation_of: Test/CF/EC150-F.test.cpp
layout: document
redirect_from:
- /verify/Test/CF/EC150-F.test.cpp
- /verify/Test/CF/EC150-F.test.cpp.html
