...
data:
  ...
  bundledCode: "#line 1 \"Test/AOJ/2862.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2862\"\
    ...
    \ s));\n}\n\n} // namespace geometryR2\n\n} // namespace zawa\n#line 7 \"Test/AOJ/2862.test.cpp\"\
    \n\n#line 9 \"Test/AOJ/2862.test.cpp\"\n#include <vector>\n\nusing namespace zawa::geometryR2;\n\
    \nint main() {\n    int n; std::cin >> n;\n    std::vector<Real> r(n);\n    std::vector<Point>\
    \ s(n), t(n);\n    for (int i{} ; i < n ; i++) {\n        std::cin >> r[i] >>\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2862\"\n\n#include\
  ...
  verifiedWith: []
documentation_of: Test/AOJ/2862.test.cpp
layout: document
redirect_from:
- /verify/Test/AOJ/2862.test.cpp
- /verify/Test/AOJ/2862.test.cpp.html
