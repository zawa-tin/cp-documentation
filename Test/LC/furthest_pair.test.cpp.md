...
data:
  ...
  bundledCode: "#line 1 \"Test/LC/furthest_pair.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/furthest_pair\"\
    ...
    } // namespace geometryZ2\n\n} // namespace zawa\n#line 4 \"Test/LC/furthest_pair.test.cpp\"\
    \nusing namespace zawa::geometryZ2;\n\n#line 7 \"Test/LC/furthest_pair.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/furthest_pair\"\n\n#include\
    ...
    \    std::cin >> T;\n    while (T--) {\n        int N;\n        std::cin >> N;\n\
    \        PointCloud P(N);\n        for (auto& p : P) std::cin >> p;\n        auto\
    \ [i, j] = FurthestPairOfPoints<int>(P);\n        std::cout << i << ' ' << j <<\
    \ '\\n';\n    }\n}\n"
  dependsOn:
  - Src/GeometryZ2/Distance/FurthestPairOfPoints.hpp
  - Src/GeometryZ2/PointCloud.hpp
  ...
  verifiedWith: []
documentation_of: Test/LC/furthest_pair.test.cpp
layout: document
redirect_from:
- /verify/Test/LC/furthest_pair.test.cpp
- /verify/Test/LC/furthest_pair.test.cpp.html
