...
data:
  ...
  bundledCode: "#line 1 \"Test/LC/count_points_in_triangle/TriangleProduct.test.cpp\"\
    ...
    \n} // namespace geometryZ2\n\n} // namespace zawa\n#line 5 \"Test/LC/count_points_in_triangle/TriangleProduct.test.cpp\"\
    \nusing namespace zawa;\nusing namespace geometryZ2;\n\n#line 10 \"Test/LC/count_points_in_triangle/TriangleProduct.test.cpp\"\
    \nusing namespace std;\n\nint main() {\n    cin.tie(0);\n    cout.tie(0);\n  \
    \  ios::sync_with_stdio(0);\n    int N;\n    cin >> N;\n    PointCloud P(N);\n\
    \    for (int i = 0 ; i < N ; i++)\n        cin >> P[i];\n    int M;\n    cin\
    \ >> M;\n    PointCloud Q(M);\n    for (int i = 0 ; i < M ; i++)\n        cin\
    \ >> Q[i];\n    TriangleProduct<AdditiveGroup<long long>> cpit(P,Q,vector<long\
    \ long>(M,1));\n    int q;\n    cin >> q;\n    while (q--) {\n        int a,b,c;\n\
  ...
  verifiedWith: []
documentation_of: Test/LC/count_points_in_triangle/TriangleProduct.test.cpp
layout: document
redirect_from:
- /verify/Test/LC/count_points_in_triangle/TriangleProduct.test.cpp
- /verify/Test/LC/count_points_in_triangle/TriangleProduct.test.cpp.html
