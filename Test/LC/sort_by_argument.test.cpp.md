...
data:
  ...
  bundledCode: "#line 1 \"Test/LC/sort_by_argument.test.cpp\"\n#define PROBLEM \"\
    ...
    \ \n\n} // namespace zawa\n#line 5 \"Test/LC/sort_by_argument.test.cpp\"\n\nint\
    \ main() {\n    using namespace zawa;\n    using namespace geometryZ2;\n    SetFastIO();\n\
    \    int n; std::cin >> n;\n    PointCloud p(n);\n    for (auto& v : p) std::cin\
    \ >> v;\n    ArgSort(p);\n    for (const auto& v : p) std::cout << v.x() << '\
    \ ' << v.y() << '\\n';\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/sort_points_by_argument\"\
    \n\n#include \"../../Src/Template/IOSetting.hpp\"\n#include \"../../Src/GeometryZ2/PointCloud.hpp\"\
    \n\nint main() {\n    using namespace zawa;\n    using namespace geometryZ2;\n\
    \    SetFastIO();\n    int n; std::cin >> n;\n    PointCloud p(n);\n    for (auto&\
    \ v : p) std::cin >> v;\n    ArgSort(p);\n    for (const auto& v : p) std::cout\
    \ << v.x() << ' ' << v.y() << '\\n';\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: Test/LC/sort_by_argument.test.cpp
layout: document
redirect_from:
- /verify/Test/LC/sort_by_argument.test.cpp
- /verify/Test/LC/sort_by_argument.test.cpp.html
