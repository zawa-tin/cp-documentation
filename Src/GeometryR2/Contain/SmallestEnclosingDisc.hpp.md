...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Src/GeometryR2/Contain/SmallestEnclosingDisc.hpp\"\n\n#line\
  ...
  code: "#pragma once\n\n#include \"../Circle.hpp\"\n#include \"../PointCloud.hpp\"\
    ...
    \n\n#include <algorithm>\n#include <cassert>\n#include <ranges>\n#include <random>\n\
    \nnamespace zawa {\n\nnamespace geometryR2 {\n\nnamespace internal {\n\nCircle\
    \ SmallestEnclosingDisc(PointCloud&& P, usize seed = 42) {\n    assert(P.size());\n\
    \    if (std::ssize(P) == 1) return Circle{P[0], 0};\n    std::mt19937 mt{seed};\n\
    \    std::ranges::shuffle(P, mt);\n    auto disc_with_two_point = [&](usize n,\
    \ const Point& q1, const Point& q2) -> Circle {\n        Circle res{q1, q2}; \n\
    \        for (usize i = 0 ; i < n ; i++) if (CircleContainsPoint(res, P[i]) ==\
...
layout: document
redirect_from:
- /library/Src/GeometryR2/Contain/SmallestEnclosingDisc.hpp
- /library/Src/GeometryR2/Contain/SmallestEnclosingDisc.hpp.html
