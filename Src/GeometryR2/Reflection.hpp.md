...
data:
  ...
  bundledCode: "#line 2 \"Src/GeometryR2/Reflection.hpp\"\n\n#line 2 \"Src/GeometryR2/Point.hpp\"\
    ...
    \ Line& line) {\n    assert(line.isValid());\n    Real coeff{Dot(line.p1() - line.p0(),\
    \ point - line.p0()) / Point{line.p1() - line.p0()}.normSquare()};\n    return\
    \ coeff * line.p1() + (static_cast<Real>(1) - coeff) * line.p0();\n}\n\n} // namespace\
...
layout: document
redirect_from:
- /library/Src/GeometryR2/Reflection.hpp
- /library/Src/GeometryR2/Reflection.hpp.html
